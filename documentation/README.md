...
| [`architecture/ui-remediation-20260915.md`](architecture/ui-remediation-20260915.md) | Đặc tả đợt Master Bento remediation tháng 09/2026: output-boundary visual compositor, Light Soft Modern palette, bounded-scroll contracts, realtime Bento, AI/ML Command Center và High-Tech Research Lab. Viết bằng tiếng Việt. |
