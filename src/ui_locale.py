...
COLUMN_LABELS = {
    ...
    "component_availability_required": "Yêu cầu thành phần có sẵn",
    "selection": "Lựa chọn hiệu chỉnh",
    "chosen": "Phương pháp được chọn",
    "selected": "Đã so sánh phương pháp",
    "fit_days": "Số ngày huấn luyện",
    "holdout_days": "Số ngày kiểm định riêng",
    ...
    "ly_do": "Lý do",
    "tham_dinh": "Thẩm định ngoài mẫu",
    "so_ky_khop": "Số kỳ đã khớp",
    "so_ky_tham_dinh": "Số kỳ thẩm định",
    "logloss_ngoai_mau": "LogLoss ngoài mẫu",
    "loi_tuong_doi": "Lợi tương đối",
    ...
    "base_count": "Cỡ mẫu",
    "base_date": "Ngày gốc",
    "baseline_brier": "Brier đường cơ sở",
    "baseline_logloss": "LogLoss đường cơ sở",
    "brier": "Brier",
    "brier_skill": "Kỹ năng Brier",
