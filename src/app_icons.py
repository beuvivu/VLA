...
DUONG_VE: Final[dict[str, tuple[str, ...]]] = {
    "tim-kiem": ("M8.5 3.5a5 5 0 1 0 0 10 5 5 0 0 0 0-10z", "M12.3 12.3 17 17"),
    "che-do": ("M10 3a7 7 0 1 0 0 14V3z", "M10 3a7 7 0 0 1 0 14"),
    "toan-man-hinh": ("M3 7V3h4M13 3h4v4M17 13v4h-4M7 17H3v-4",),
    # --- Trực tiếp -----------------------------------------------------------
    "truc-tiep": (
