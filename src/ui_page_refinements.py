...
_BASE_BG = "linear-gradient(135deg,#F4F5FF 0%,#EAEBFF 48%,#E8ECFF 100%)"
...
_PATH_CSS = rf"""
.path-page{{--bg:#F4F5FF;--card:rgba(255,255,255,.88);--text:#0f172a;--muted:#64748b;--line:#dbe3f0;--hit:#f59e0b;--hitde:#dc2626;--ok:#059669;--chip:#eef2ff;--ui-bg:#F4F5FF;--ui-surface:rgba(255,255,255,.92);--ui-surface-2:#f8fafc;--ui-ink:#0f172a;--ui-ink-2:#334155;--ui-ink-soft:#64748b;--ui-border:#dbe3f0;--ui-brand:#4f46e5;--ui-brand-soft:#eef2ff;--ui-brand-border:#c7d2fe;min-height:100vh;padding-bottom:calc(var(--ui-dock-h,64px) + env(safe-area-inset-bottom) + 2rem);background:{_BASE_BG};color:#0f172a}}
...
.path-page th{{background:rgba(248,250,252,.98);color:#334155}}.path-page td{{color:#0f172a;border-color:#e2e8f0}}.path-page tr:hover td{{background:#f8faff}}
...
_LIVE_CSS = rf"""
.live-console{{--bg:#F4F5FF;--card:rgba(255,255,255,.9);--card-2:#f8fafc;--line:#dbe3f0;--ink:#0f172a;--ink-2:#475569;--ink-3:#64748b;--accent:#4f46e5;--ok:#059669;--ok-line:#a7f3d0;--warn:#d97706;--warn-line:#fed7aa;--hot:#DC2626;min-height:100vh;padding-bottom:calc(var(--ui-dock-h,64px) + env(safe-area-inset-bottom) + 1rem);background:{_BASE_BG};color:#0f172a}}
...
.live-console .slot{{background:#fff;border-color:#dbe3f0;color:#0f172a}}.live-console .slot.is-empty{{color:#64748b;background-color:#E2E8F0;background-image:repeating-linear-gradient(135deg,transparent 0 7px,rgba(156,163,175,.38) 7px 8px);border-color:#cbd5e1}}.live-console .slot.is-special{{color:#DC2626;border-color:#f87171;background:#FEE2E2}}
