...
def registry() -> list[Strategy]:
    return [
        Strategy("Đặc Biệt lặp lại", "special", _special_repeat, "Hai số cuối Đặc Biệt hôm nay."),
        Strategy("Đặc Biệt lộn", "special", _special_reverse, "Đảo hai số cuối Đặc Biệt."),
        Strategy("Bóng Đặc Biệt", "bong", _special_bong, "Bóng 0↔5,1↔6,2↔7,3↔8,4↔9."),
        Strategy("Bộ Đặc Biệt", "bong", _special_bo, "Họ số bóng/lộn của Đặc Biệt."),
        Strategy("Ghép ĐB×G1", "cross_prize", _db_g1_cross, "Đầu Đặc Biệt ghép đuôi G1 và số đảo."),
        Strategy("Chạm đầu Đặc Biệt", "touch", _touch_head, "Mọi số chứa chữ số đầu Đặc Biệt."),
        Strategy("Chạm đuôi Đặc Biệt", "touch", _touch_tail, "Mọi số chứa chữ số đuôi Đặc Biệt."),
        Strategy("Dàn đầu Đặc Biệt", "head_tail", _same_head, "10 số cùng đầu Đặc Biệt."),
        Strategy("Dàn đuôi Đặc Biệt", "head_tail", _same_tail, "10 số cùng đuôi Đặc Biệt."),
        Strategy("Dàn tổng Đặc Biệt", "sum", _same_sum, "10 số cùng tổng mod 10 với Đặc Biệt."),
